%==========================================================================
% Purpose: Enable pupil capture to be controlled with MATLAB.  Run 
% sample_mm.py to set up the python middle man server before attempting to
% initialize the UDP connection from MATLAB.
...
% want with regards to customizing the file name, fields...
...
fwrite(hUDP,'2') %%%%%EDIT THIS TO ALLOW TRIGGERS 1:255
